	...
	return (
		<div className='flex flex-row space-x-3 mx-4 mt-2 p-2 mb-3'>
			<div className='w-8 h-8 rounded-lg'>
				<Avatar className={'rounded-full items-center justify-center mt-1.5'}>
					<AvatarImage src="https://upload.wikimedia.org/wikipedia/en/thumb/8/86/University_of_Chittagong_logo.svg/800px-University_of_Chittagong_logo.svg.png" alt="@shadcn" />
